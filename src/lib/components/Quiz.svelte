		...
		<div>
			...
			<div class="mb-8">
				...
				<div class="h-3 bg-cream-100 rounded-full overflow-hidden">
					<div
						class="h-full bg-nacho-500 rounded-full transition-[width] duration-500 ease-out"
				...
				<div class="grid md:grid-cols-2 gap-4">
					{#each questions[currentQuestion].answers as answer}
						<button
							...
							class="bg-white border-2 border-transparent hover:border-nacho-300 hover:bg-nacho-50 rounded-xl p-6 text-left transition-[colors,box-shadow] shadow-md hover:shadow-lg"
						>
