...
<objective>
Generate custom product images for all 5 cheese flavors using fruitsnake-mcp, verify visual consistency with the user, then integrate them into the flavor card components.
...
<task type="checkpoint:human-verify" gate="blocking">
  <name>Task 2: Verify flavor image visual consistency before integration</name>
  <what-built>
    5 custom flavor product images generated with fruitsnake-mcp:
    - src/lib/assets/images/flavors/white-cheese.png
    - src/lib/assets/images/flavors/orange-spice.png
    - src/lib/assets/images/flavors/mozz-pure.png
    - src/lib/assets/images/flavors/cheddar-beddar.png
    ...
    All images should share a consistent visual style (same lighting, composition, background, bowl presentation) since a style fingerprint was used across generations.
  </what-built>
  <how-to-verify>
    1. Open all 5 images in a file viewer or image gallery:
       - src/lib/assets/images/flavors/white-cheese.png
       - src/lib/assets/images/flavors/orange-spice.png
       - src/lib/assets/images/flavors/mozz-pure.png
       - src/lib/assets/images/flavors/cheddar-beddar.png
       - src/lib/assets/images/flavors/mega-spice.png
    2. Check visual consistency across all 5:
       - Same lighting direction and intensity
       - Same composition/framing (centered bowl, similar angle)
       - Same background style (clean, white/neutral)
       - Similar level of detail and realism
    3. Check individual image quality:
       - Each image clearly represents its flavor (color, texture match the name)
       - No artifacts, distortions, or text rendering issues
       - Images look appetizing and on-brand (west coast, playful)
    4. Check MEGA SPICE specifically:
       - Should look noticeably more intense/fiery than the others
       - Visible chili/spice elements
  </how-to-verify>
  <resume-signal>Type "approved" if all 5 images look good and visually consistent, or describe specific issues (e.g., "white-cheese looks too yellow", "inconsistent lighting on mozz-pure")</resume-signal>
</task>

<task type="auto">
  <name>Task 3: Add image field to Flavor type and integrate images into FlavorCard and MegaSpiceCard</name>
  <files>
    src/lib/data/flavors.ts
    src/lib/components/FlavorCard.svelte
    src/lib/components/MegaSpiceCard.svelte
